...
const AddSliderAndAds = (props) => {
  ...
  const id = router.query.sliderId;
  console.log(id);
              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="form-group">
                    ...
                    <div className="mb-2">
                      {main.map((item, index) => (
                        <input type="text" className="form-control" name="title" onChange={changeStateUpdateHandler} placeholder={item.title} key={index} />
                      ))}
                    </div>
                  </div>
                </div>
                    ...
                    <div className="mb-2">
                      {main.map((item, index) => (
                        <input
                          ...
                          placeholder={item.shortDiscription}
                        />
                      ))}
                    </div>
                  </div>
