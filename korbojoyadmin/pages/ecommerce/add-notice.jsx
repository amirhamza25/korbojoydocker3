...
const AddNotice = () => {
  ...
  const sliderHandleSubmit = async (e) => {
    ...
    const response = await axios
      .post(process.env.API_URL + "/SubmitNotice", slider)
      .then((response) => {
        MySwal.fire("Good job!", "Add notice successfully", "success");
      })
      .catch((error) => {
              ...
              <div className="row">
                ...
                <div className="col-md-6">
                  <div className="form-group">
                    ...
                    <div className="mb-2">
                      <input type="date" className="form-control" name="date" onChange={changeStateUpdateHandler} placeholder="date" />
                    </div>
                  </div>
                </div>
              </div>
