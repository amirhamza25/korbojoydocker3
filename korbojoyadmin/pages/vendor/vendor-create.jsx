            ...
            <div className="card-body">
              <form onSubmit={agentHandleSubmit} method="post" className="form-horizontal" encType="multipart/form-data">
                <div className="form-row">
                  <div className="col-md-6">
                    <div className="form-group">
                      ...
                      <div className="mb-2">
                        <input type="text" className="form-control" id="fname" name="name" onChange={categoryHandleChange} placeholder="Enter vendor name" />
                      </div>
                    </div>
                  </div>
                  <div className="col-md-6">
                ...
                <div className="form-group">
                  ...
                  <div className="mb-2">
                    <input type="email" className="form-control" id="fname" name="email" onChange={categoryHandleChange} placeholder="Enter vendor Email" />
                  </div>
                </div>
